...
public class SeeProducts extends AppCompatActivity {
    ...
    private class MyOnClickListener implements View.OnClickListener {
        ...
        private MyOnClickListener(SeeProducts context) {
        ...
        public void onClick(final View v) {
            ...
            requestQueue = Volley.newRequestQueue(getApplicationContext());
            String API = "http://10.0.2.2:8080/warehouse/admin/product/" + carPartName.getText().toString();
            ...
            final Intent i = new Intent(context, ProductDetails.class);
    ...
    private void parseResult(){
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, "http://10.0.2.2:8080/warehouse/admin/products", null,
